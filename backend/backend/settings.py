...
SECRET_KEY = 'django-insecure-&obds^l6al-nh&i^ghvyxxa9uiga^&r&j3w23it5z9mp*m(_k-'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['akifshah7.pythonanywhere.com']
...
LOGGING = {
    ...
    'loggers': {
        'django': {
            'handlers': ['console', 'file'],
            'level': 'INFO',  # Django's own logs, adjust as needed
            'propagate': False,
        },
